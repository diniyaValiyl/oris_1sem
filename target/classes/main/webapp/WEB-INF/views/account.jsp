                                ...
                                <c:forEach var="appointment" items="${appointments}">
                                    <div class="appointment-card">
                                        <div class="appointment-info">
                                            ...
                                            <!-- Обновленный блок статуса -->
                                            <c:if test="${appointment.status != 'SCHEDULED'}">
                                                <span class="status ${appointment.status.toLowerCase()}">
                                                    <c:choose>
                                                        <c:when test="${appointment.status == 'COMPLETED'}">Завершен</c:when>
                                                        <c:when test="${appointment.status == 'CANCELLED'}">Отменен</c:when>
                                                        <c:when test="${appointment.status == 'NO_SHOW'}">Неявка</c:when>
